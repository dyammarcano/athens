...
There are [a lot of ways to contribute to the Athens project](./participating) and being a maintainer is only one of
those paths. Maintainers on the Athens Project are expected to
...
- Help foster a safe and welcoming environment for all project participants.
  ...
  Covenant](https://www.contributor-covenant.org), if you haven't read it yet you can do
  so [here](https://www.contributor-covenant.org/version/1/4/code-of-conduct) (english version).

We'd love to have your partnership in building Athens, but it is a statement to the commitment that a project of Athens'
size and
...
You don't need to do anything other than visit our [GitHub page](https://github.com/dyammarcano/athens) to do all of the
above!