...
Generally we will still want to try and follow the issue template
for [bugs](https://github.com/dyammarcano/athens/blob/main/.github/ISSUE_TEMPLATE/bug_report.md) or
[features](https://github.com/dyammarcano/athens/blob/main/.github/ISSUE_TEMPLATE/feature_request.md). If you are
performing
issue triage you may need to add more
