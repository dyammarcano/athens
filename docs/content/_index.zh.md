...
Athens 为你运行 [Go 模块](https://github.com/golang/go/wiki/Modules) 提供服务。它可以为你提供公有和私有的代码，因此，你不需要直接从像
GitHub 或 GitLab 等版本控制系统（VCS）上拉取。
...
我们还运行了一个体验版本的 Athens,因此你什么都不需要安装也能开始。为此，你需要设置环境变量
...
查看我们的问题列表中的 [good first issues](https://github.com/dyammarcano/athens/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
