...
go build -ldflags "-X github.com/dyammarcano/athens/pkg/build.version=$version -X github.com/dyammarcano/athens/pkg/build.buildDate=$date" -o athens ./cmd/proxy
```
