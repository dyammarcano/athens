...
In this document, we'll show how to
use [AWS Fargate (ECS)](https://docs.aws.amazon.com/AmazonECS/latest/userguide/what-is-fargate.html) to run the Athens
proxy.
...
Below are two examples of creating the s3 bucket using the [awscli](https://aws.amazon.com/cli/)
