...
// `go build -ldflags "-X github.com/dyammarcano/athens/pkg/build.version=$(git describe --tags) -X github.com/dyammarcano/athens/pkg/build.buildDate=$(date -u +%Y-%m-%d-%H:%M:%S-%Z)"`
package build
